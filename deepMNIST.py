# -*- coding: utf-8 -*-
"""
Created on Wed Oct 18 20:33:38 2017
...
# reshape x to a 4d tensor, with:
# the second and third dimensions corresponding to image width and height, and the 
...
for i in range(20000):
  ...
  if i%1000 == 0: # logging to every 100th iteration in the training process
